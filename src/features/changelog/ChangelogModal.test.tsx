...
describe('ChangelogModal', () => {
  it('shows the latest English update and closes from either action', async () => {
    ...
    expect(dialog.querySelector('h3')).toHaveTextContent('Easier to read, quicker to sort')
    expect(dialog).toHaveTextContent('September 25, 2026')
    expect(dialog).toHaveTextContent('how much you lent or how much you owe')
    expect(dialog).toHaveTextContent('Money coming to you is shown in green')
    expect(dialog).toHaveTextContent('your choice always wins')
  ...
  it('renders the same update naturally in Simplified Chinese', () => {
    ...
    expect(dialog.querySelector('h3')).toHaveTextContent('更清晰，也更省心')
    expect(dialog).toHaveTextContent('2026年9月25日')
    expect(dialog).toHaveTextContent('你借出多少，或你应付多少')
    expect(dialog).toHaveTextContent('你的选择优先')
