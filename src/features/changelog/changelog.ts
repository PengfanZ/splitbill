...
export const CHANGELOG_ENTRIES: readonly ChangelogEntry[] = [
  ...
  },
  {
    ...
    summaryKey: 'changelog.release.friendsSummary',
    items: [
      {
        icon: 'polish',
        titleKey: 'changelog.item.removeFriendTitle',
        descriptionKey: 'changelog.item.removeFriendDescription',
      },
      {
        icon: 'live',
        titleKey: 'changelog.item.restoreFriendTitle',
        descriptionKey: 'changelog.item.restoreFriendDescription',
      },
    ],
  },
  {
    ...
    titleKey: 'changelog.release.csvTitle',
    summaryKey: 'changelog.release.csvSummary',
    items: [
      {
        icon: 'csv',
        titleKey: 'changelog.item.csvScopeTitle',
        descriptionKey: 'changelog.item.csvScopeDescription',
      },
      {
        icon: 'csv',
        titleKey: 'changelog.item.csvDetailsTitle',
        descriptionKey: 'changelog.item.csvDetailsDescription',
      },
    ],
  },
  {
    ...
    titleKey: 'changelog.release.receiptTitle',
    summaryKey: 'changelog.release.receiptSummary',
    items: [
      {
        icon: 'receipt',
        titleKey: 'changelog.item.receiptScanTitle',
        descriptionKey: 'changelog.item.receiptScanDescription',
      },
      {
        icon: 'aiReview',
        titleKey: 'changelog.item.receiptAssignTitle',
        descriptionKey: 'changelog.item.receiptAssignDescription',
      },
    ],
  },
  {
